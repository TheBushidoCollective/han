...
Comprehensive Cypress testing framework skills for end-to-end testing of web
applications with custom commands and CI/CD integration.
...
```bash
npx @thebushidocollective/han plugin install jutsu-cypress
```
