...
Comprehensive TestNG testing framework skills for Java projects with annotations,
data providers, and parallel execution.
...
```bash
npx @thebushidocollective/han plugin install jutsu-testng
```
