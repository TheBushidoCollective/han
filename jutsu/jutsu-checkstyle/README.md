...
Comprehensive Checkstyle skills for Java code quality and style enforcement with
configuration, checks, and custom check development.
...
```bash
npx @thebushidocollective/han plugin install jutsu-checkstyle
```
