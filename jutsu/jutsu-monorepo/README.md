...
Advanced monorepo development skills for architecture, tooling, and workflow
management across multiple packages and projects.
...
```bash
npx @thebushidocollective/han plugin install jutsu-monorepo
```
