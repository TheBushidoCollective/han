 ...
 *
 * This provider is discovered and loaded by han's memory system when the
 * hashi-github plugin is installed.
 */
...
/**
 * Observation extracted from a source provider
 */
...
/**
 * Options for extracting observations
 */
...
/**
 * Creates the GitHub memory provider
 *
