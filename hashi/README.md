...
This directory contains all **hashi** plugins - Model Context Protocol
(MCP) server integrations that provide additional capabilities to
Claude Code through external tools and services.

## What is Hashi?

In Japanese, **hashi** (橋) means "bridge" - a connection between two places.
In software development, hashi plugins bridge Claude Code to external knowledge
sources and services through the Model Context Protocol.

## Available Bridges

### Context7

**Plugin:** `hashi-context7`
...
Each hashi plugin follows this structure:
...
## Creating New Hashi Plugins

To add a new MCP server integration:

1. Create a new `hashi-{service}` directory
