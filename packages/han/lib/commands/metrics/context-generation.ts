 ...
 */
export function getBestTaskType(
	metrics: ReturnType<JsonlMetricsStorage["queryMetrics"]>,
 ...
 */
export function getWeakestTaskType(
	metrics: ReturnType<JsonlMetricsStorage["queryMetrics"]>,
): { type: string; successRate: number } | null {
	const taskTypes = ["implementation", "fix", "refactor", "research"];
 ...
 */
export function getCalibrationEmoji(score: number): string {
	if (score >= 85) return "🎯";
	if (score >= 70) return "📈";
 ...
 */
export function getCalibrationDirection(
	metrics: ReturnType<JsonlMetricsStorage["queryMetrics"]>,
 ...
 */
export function getCalibrationGuidance(
 ...
 */
export function getHookSpecificGuidance(hookName: string): string | null {
