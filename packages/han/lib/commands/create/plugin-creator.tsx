...
type Step = "type" | "name" | "description" | "author" | "authorUrl" | "confirm";
	...
	if (step === "authorUrl") {
		return (
			<Box flexDirection="column" paddingY={1}>
				...
				<Box marginTop={1}>
					<Text dimColor>
						Press Enter to skip if you don't have a URL
					</Text>
				</Box>
			</Box>
		);
