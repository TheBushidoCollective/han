 ...
 */
export const OAuthInitiateResultRef = builder.objectRef<OAuthInitiatePayload>(
  'OAuthInitiateResult'
);
 ...
 */
export const MagicLinkResultRef =
  builder.objectRef<MagicLinkResultPayload>('MagicLinkResult');
