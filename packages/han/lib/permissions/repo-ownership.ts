 ...
 */
export function isLikelyPersonalRepo(owner: string, currentUsername?: string): boolean {
 ...
 */
export function buildRepoUrl(ownership: RepoOwnership, format: "https" | "ssh" = "https"): string {
