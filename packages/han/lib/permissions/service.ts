...
export class PermissionService {
	 ...
	 */
	async canViewSession(session: SessionForPermission): Promise<PermissionResult> {
		...
		const accessResult = await this.checkRepoAccess(ownership.owner, ownership.repo);
	 ...
	 */
	async checkRepoAccess(owner: string, repo: string): Promise<PermissionResult> {
	 ...
	 */
	setOrgSettings(orgId: string, settings: Partial<OrgVisibilitySettings>): void {
 ...
 */
export function createPermissionService(user: AuthenticatedUser): PermissionService {
