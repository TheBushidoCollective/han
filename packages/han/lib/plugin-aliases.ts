...
export const PLUGIN_ALIASES: Record<string, string> = {
  // disciplines (old short names -> new paths)
  accessibility: 'disciplines/accessibility-engineering',
  api: 'disciplines/api-engineering',
  architecture: 'disciplines/system-architecture',
  backend: 'disciplines/backend-development',
  blockchain: 'disciplines/blockchain-development',
  compilers: 'disciplines/compiler-engineering',
  content: 'disciplines/content-creation',
  databases: 'disciplines/database-engineering',
  documentation: 'disciplines/documentation-engineering',
  embedded: 'disciplines/embedded-development',
  frontend: 'disciplines/frontend-development',
  games: 'disciplines/game-development',
  graphics: 'disciplines/graphics-engineering',
  infrastructure: 'disciplines/infrastructure-engineering',
  mobile: 'disciplines/mobile-development',
  networking: 'disciplines/network-engineering',
  observability: 'disciplines/observability-engineering',
  performance: 'disciplines/performance-engineering',
  platform: 'disciplines/platform-engineering',
  product: 'disciplines/product-management',
  prompts: 'disciplines/prompt-engineering',
  quality: 'disciplines/quality-engineering',
  security: 'disciplines/security-engineering',
  sre: 'disciplines/site-reliability-engineering',
  voip: 'disciplines/voip-engineering',

  // disciplines (do-* legacy aliases)
  'do-accessibility': 'disciplines/accessibility-engineering',
  'do-accessibility-engineering': 'disciplines/accessibility-engineering',
  'do-api': 'disciplines/api-engineering',
  'do-api-engineering': 'disciplines/api-engineering',
  'do-architecture': 'disciplines/system-architecture',
  'do-backend': 'disciplines/backend-development',
  'do-backend-development': 'disciplines/backend-development',
  'do-blockchain': 'disciplines/blockchain-development',
  ...
  'do-compiler-development': 'disciplines/compiler-engineering',
  'do-compilers': 'disciplines/compiler-engineering',
  'do-content': 'disciplines/content-creation',
  'do-content-creator': 'disciplines/content-creation',
  'do-data-engineering': 'disciplines/data-engineering',
  'do-database-engineering': 'disciplines/database-engineering',
  'do-databases': 'disciplines/database-engineering',
  'do-documentation': 'disciplines/documentation-engineering',
  'do-embedded': 'disciplines/embedded-development',
  'do-embedded-development': 'disciplines/embedded-development',
  'do-frontend': 'disciplines/frontend-development',
  'do-frontend-development': 'disciplines/frontend-development',
  'do-game-development': 'disciplines/game-development',
  'do-games': 'disciplines/game-development',
  'do-graphics': 'disciplines/graphics-engineering',
  'do-graphics-engineering': 'disciplines/graphics-engineering',
  'do-infrastructure': 'disciplines/infrastructure-engineering',
  'do-machine-learning': 'disciplines/machine-learning',
  'do-machine-learning-engineering': 'disciplines/machine-learning',
  'do-mobile': 'disciplines/mobile-development',
  'do-mobile-development': 'disciplines/mobile-development',
  'do-network-engineering': 'disciplines/network-engineering',
  'do-networking': 'disciplines/network-engineering',
  'do-observability': 'disciplines/observability-engineering',
  'do-observability-engineering': 'disciplines/observability-engineering',
  'do-performance': 'disciplines/performance-engineering',
  'do-performance-engineering': 'disciplines/performance-engineering',
  'do-platform': 'disciplines/platform-engineering',
  'do-platform-engineering': 'disciplines/platform-engineering',
  'do-plugin-development': 'disciplines/claude-plugin-development',
  'do-product': 'disciplines/product-management',
  ...
  'do-prompts': 'disciplines/prompt-engineering',
  'do-quality': 'disciplines/quality-engineering',
  'do-quality-assurance': 'disciplines/quality-engineering',
  'do-security': 'disciplines/security-engineering',
  ...
  'do-sre': 'disciplines/site-reliability-engineering',
  'do-technical-documentation': 'disciplines/documentation-engineering',
  'do-voip': 'disciplines/voip-engineering',
