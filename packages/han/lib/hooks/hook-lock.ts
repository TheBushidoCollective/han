 ...
 * @param explicitSessionId - If provided, uses this session ID instead of auto-deriving
 */
export function createLockManager(explicitSessionId?: string): LockManager {
 ...
 * Uses PPID-based session detection for CLI usage.
 * MCP tools skip this entirely and run with their own timeouts.
 */
