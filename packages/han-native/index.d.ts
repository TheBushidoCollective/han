...
export declare function queryDashboardAggregates(dbPath: string, cutoffDate: string): DashboardAggregates
/** Query all activity data via SQL aggregation (replaces ~425 DB round-trips) */
export declare function queryActivityAggregates(dbPath: string, cutoffDate: string): ActivityAggregates
/**
