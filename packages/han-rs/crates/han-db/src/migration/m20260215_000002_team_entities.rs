...
impl MigrationTrait for Migration {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(SyncedSessions::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(SyncedSessions::SessionId)
                            .string()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(SyncedSessions::ProjectPath)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(SyncedSessions::EncryptedMessages)
                            .text()
                            .not_null(),
                    )
                    .col(ColumnDef::new(SyncedSessions::EncryptedSummary).text())
                    .col(
                        ColumnDef::new(SyncedSessions::MessageCount)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    ...
                    .col(
                        ColumnDef::new(SyncedSessions::CreatedAt)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(SyncedSessions::UpdatedAt)
                            .string()
                            .not_null(),
                    )
                    .foreign_key(
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(TeamInvites::Role)
                            .string()
                            .not_null()
                            .default("ic"),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(EncryptionKeys::OwnerType)
                            .string()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(EncryptionKeys::WrapNonce)
                            .string()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(EncryptionKeys::Active)
                            .boolean()
                            .not_null()
                            .default(true),
                    )
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            ...
            .await?;
        manager
            .drop_table(Table::drop().table(SyncedSessions::Table).to_owned())
            .await?;
        manager
