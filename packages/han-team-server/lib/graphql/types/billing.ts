...
// Note: UserTierEnum is imported from ./user.ts to avoid duplicate definitions
...
import { UserRef, UserTierEnum } from "./user.ts";
...
// Note: tier field is already defined on UserType in user.ts
