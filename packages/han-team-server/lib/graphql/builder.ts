 ...
 *
 * @description Handles serialization and parsing of arbitrary JSON:
 * - Serializes any value as-is (GraphQL-JS handles JSON encoding)
 * - Parses JSON values directly (already parsed by GraphQL-JS)
 */
builder.scalarType("JSON", {
  description: "Arbitrary JSON data (objects, arrays, primitives)",
