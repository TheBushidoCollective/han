...
```bash
npx @thebushidocollective/han plugin install buki-android
```
...
- **buki-kotlin**: Kotlin language skills
- **buki-java**: Java language skills
- **buki-expo**: React Native with Expo
