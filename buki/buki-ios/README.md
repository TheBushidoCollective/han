...
```bash
npx @thebushidocollective/han plugin install buki-ios
```
...
- **buki-swift**: Swift language skills and SwiftLint validation
- **buki-objective-c**: Objective-C development skills
