 ...
 * Adapted for the Kiro bridge with HAN_PROVIDER=kiro.
 */
...
export function executeHook(
  ...
  // biome-ignore lint/suspicious/noTemplateCurlyInString: intentional string match for HAN_FILES placeholder
