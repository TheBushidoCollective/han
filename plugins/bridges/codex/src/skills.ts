/**
 * Skill discovery and registration for Codex CLI.
 *
 * Scans installed Han plugins for skills/ directories containing SKILL.md
 * files. Registers tools that let the LLM list and load skills.
 *
 * Codex has its own skill system (~/.codex/skills/) but this tool
