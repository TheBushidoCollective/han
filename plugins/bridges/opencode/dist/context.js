 ...
 */
export function buildSessionContext(skillCount, disciplineCount) {
    const lines = [CORE_GUIDELINES];
    // Summary of available capabilities
    lines.push(`<han-capabilities>`);
    lines.push(`Han bridge active with ${skillCount} skills and ${disciplineCount} disciplines available.`);
 ...
 */
export function loadGuideline(pluginPaths, fileName) {
