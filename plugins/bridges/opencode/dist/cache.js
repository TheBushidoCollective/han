...
function cacheKey(pluginName, hookName, filePath) {
 ...
 */
export function shouldSkipHook(pluginName, hookName, filePath) {
 ...
 */
export function recordSuccess(pluginName, hookName, filePath) {
