...
postgresql:query-database - Execute SQL queries against PostgreSQL database
...
Execute SQL queries against the configured PostgreSQL database. Supports SELECT, INSERT, UPDATE, DELETE, and DDL operations depending on database user permissions.
...
1. Connect to PostgreSQL using the configured connection string
...
Claude: Executing query against PostgreSQL...
