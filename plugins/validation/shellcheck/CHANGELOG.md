...
- add HAN_FILES support to biome and shellcheck hooks ([b9fcf2f6](../../commit/b9fcf2f6))
...
- remove SubagentStop hooks from jutsu plugins ([7396230c](../../commit/7396230c))
...
- fix markdown formatting in CHANGELOG files ([21ca9a75](../../commit/21ca9a75))
- remove trailing blank lines from CHANGELOG files ([999bbf73](../../commit/999bbf73))
- resolve markdownlint warnings in README ([a6d2496c](../../commit/a6d2496c))
...
- add jutsu-shellcheck plugin for shell script validation ([9a303a5f](../../commit/9a303a5f))
